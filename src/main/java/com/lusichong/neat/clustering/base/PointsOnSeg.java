...
public class PointsOnSeg {
    ...
    public boolean isNeighbor(RoadMap roadmap, PointsOnSeg otherSeg) {
        ...
        return (rs1.getJunctionIndex(rs2.getSourceJunction()) != -1) || (rs1.getJunctionIndex(rs2.getTargetJunction()) != -1);
    }
    ...
    public RoadJunction getSharedJunction(RoadMap roadmap, PointsOnSeg otherPs) {
        ...
        if ((rs1.getJunctionIndex(rs2.getSourceJunction()) == -1) || (rs1.getJunctionIndex(rs2.getTargetJunction()) == -1))
            return null;
    ...
    public boolean isEndPoint(RoadMap rm, RoadJunction junc) {
        if (this.getRoadSeg(rm) == null) return true;
